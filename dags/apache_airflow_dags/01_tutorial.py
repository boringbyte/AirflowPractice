...
with DAG(dag_id='01_tutorial', description='A simple tutorial DAG', schedule=timedelta(days=1),
         start_date=datetime(2022, 10, 15), catchup=False, tags=['example'],
         default_args={
    ...
    t1 = BashOperator(task_id='print_data', bash_command='date')
